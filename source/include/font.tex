...
\begin{verbatim}
% 西文默认衬线字体、无衬线字体及等宽字体的设定
\setmainfont{Libertinus Serif}
\setsansfont{TeX Gyre Heros}
\setmonofont{Libertinus Mono}

% 中文默认衬线字体、无衬线字体及等宽字体的设定
...
TODO：math mode的字体调用较为复杂多样，暂不赘述。
...
\LaTeX{} 提供了 |symbol| 命令，可以直接借助于字符编码插入字符，参考本书\ref{how-to-find-symbols}。
